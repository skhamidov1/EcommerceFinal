            ...
            <nav className="nav">
                ...
                <li className="nav__list-item nav__list-item--padding">
                    ...
                    <li className="nav__list-item nav__list-item--margin">
                        <NavLink exact={false} to="/home" >RoyalRentals</NavLink>
                    </li>
                    ...
                    {auth0Client.isAuthenticated() ? (<li className="nav__list-item">
                        <NavLink to ="/admin" activeClassName="active">Admin</NavLink></li>) : null}
                </ul>
               ...
               {!auth0Client.isAuthenticated() && (
                    <div>
                        <button className="nav__auth" onClick={auth0Client.signIn}>Log In</button>
                    </div>
               )}
               ...
               {auth0Client.isAuthenticated() && (
                   <div>
                        <button className="nav__auth" onClick={auth0Client.signOut}>Log Out</button>
                   </div>
               )}
